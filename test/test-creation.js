...
describe('bagle-component generator', function () {
  var gen;

  function generatorTest(generatorType, name, mockPrompt, callback) {
    var ngGenerator;
    var deps = [path.join('../..', generatorType)];
    ngGenerator = helpers.createGenerator('bagle-component:' + generatorType, deps, [name]);
  ...
  describe('with default configuration', function() {
    beforeEach(function (done) {
      helpers.testDirectory(path.join(__dirname, 'temp'), function (err) {
        ...
        gen = helpers.createGenerator('bagle-component:app', [
          '../../app'
        ]);
        done();
      }.bind(this));
